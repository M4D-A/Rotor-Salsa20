...
int main(){
  uint32_t key[8] = {0x90ABCDEF, 0x12345678, 0x90ABCDEF, 0x12345678, 0x90ABCDEF, 0x12345678, 0x90ABCDEF, 0x12345678};
  uint32_t nonce[2] = {0x90ABCDEF, 0x12345678};
  uint32_t counter[2] = {3,0};
  uint32_t state[16] = {0};
  uint8_t state8[64] = {0};
